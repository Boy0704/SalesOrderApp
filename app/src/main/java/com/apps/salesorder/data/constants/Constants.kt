package com.apps.salesorder.data.constants

class Constants {

    object DEFAULT {
        const val BASE_URL = "base_url_api"
//        const val BASE_URL = "http://192.168.129.54"
        ...
        const val CODE_BARCODE_TEMP = "code_barcode_temp"
    ...
    object INTENT {
        ...
        const val IMG_KTP = 71
        const val IMG_SIM = 72
        const val IMG_SELFIE = 73
        const val IMG_BUKTI_BAYAR = 74
        const val MULTI_UPLOAD = 75
        const val INDIKATOR_BENSIN_AWAL = 76
    }
