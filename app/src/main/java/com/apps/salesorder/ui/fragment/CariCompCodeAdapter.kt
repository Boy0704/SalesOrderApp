...
class CariCompCodeAdapter(
    val listData: ArrayList<Debtor>,
    var listener: OnAdapterListener
): RecyclerView.Adapter<CariCompCodeAdapter.ViewHolder>(), Filterable {

    private var dataFilter = ArrayList<Debtor>()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.name.text = list.accNo
        holder.binding.description.text = list.companyName
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                dataFilter = results?.values as ArrayList<Debtor>
